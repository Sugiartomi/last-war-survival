...
import PaymentReportCrystalModal from "./Invoice";

export default function CrystalHistory() {
	...
	return (
		<>
					...
					<tbody className="fs-16">
						<tr>
							<td
								...
								data-bs-target="#CrystalHistoryModal-Pending"
							>
								25472548554
							</td>
						...
						<tr>
							<td
								className="text-primary py-3 pointer"
								data-bs-toggle="modal"
								data-bs-target="#CrystalHistoryModal-Waiting"
							>
								25472548555
							</td>
						...
						<tr>
							<td
								className="text-primary py-3 pointer"
								data-bs-toggle="modal"
								data-bs-target="#CrystalHistoryModal-Paid"
							>
								25472548556
							</td>
							<td className="text-center py-3">08-01-2023 19:15</td>
			...
			<div
				...
				id="CrystalHistoryModal-Paid"
				tabindex="-1"
				aria-labelledby="CrystalHistoryModal-PaidLabel"
				aria-hidden="true"
			>
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						{/* <div class="modal-header">
							<h1 class="modal-title fs-5" id="CrystalHistoryModal-PaidLabel">
								Modal title
							</h1>
							<button
								type="button"
						...
						<hr />
						<div className="d-flex justify-content-between px-3 pb-3 font-inter">
							<div>
								<button
									type="button"
									className="btn btn-primary"
									data-bs-toggle="modal"
									data-bs-target="#PaymentReportCrystalModal"
								>
									View Invoice
								</button>
							</div>
			...
			<PaymentReportCrystalModal />

			{/* <!-- Modal Pending--> */}
			<div
				class="modal modal-lg fade"
				id="CrystalHistoryModal-Pending"
				tabindex="-1"
				aria-labelledby="CrystalHistoryModal-PendingLabel"
				aria-hidden="true"
			>
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						{/* <div class="modal-header">
							<h1 class="modal-title fs-5" id="CrystalHistoryModal-PendingLabel">
								Modal title
							</h1>
							<button
								type="button"
						...
						<div class="modal-body">
							<div className="row">
								<div
									className="font-inter text-center fw-600 p-3"
									style={{ fontSize: 18 }}
								>
									Detail Transaction Active
								</div>
								...
								<div className="container mt-3">
									...
									<div className="row px-5">
										...
										<div className="col-3">
											...
											<p className="font-roboto fs-14 fw-600">: Crystal</p>
			...
			<div
				class="modal modal-lg fade"
				id="CrystalHistoryModal-Waiting"
				tabindex="-1"
				aria-labelledby="CrystalHistoryModal-WaitingLabel"
				aria-hidden="true"
			>
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						{/* <div class="modal-header">
							<h1 class="modal-title fs-5" id="CrystalHistoryModal-WaitingLabel">
								Modal title
							</h1>
							<button
								type="button"
