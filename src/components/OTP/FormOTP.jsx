...
class OtpFormCustom extends React.Component {
  constructor(props) {
    super(props)
  ...
  render () {
    ...
    const { inputsArray } = this.state
    return (
      <div className="otp-form-container-custom">
        <div className="otp-inputs-section-custom">
          {inputsArray.map((input, index) => (
            <div className="otp-input-group-custom" key={input.id}>
              <input
