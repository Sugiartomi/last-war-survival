...
export default function ActivationKeyCard() {
	...
	return (
		<>
							...
							<div className="d-flex justify-content-between">
								<div className="d-flex align-items-center">
									...
									<div
										...
										style={{ fontSize: 40 }}
									>
										{activationKey.total.toLocaleString().replaceAll(",", ".")}
									</div>
								</div>
								<div className="d-flex align-items-center">
									{activationKey.pcs == 0 ? (
										<div className="btn btn-secondary px-5 py-2">Buy</div>
									) : (
										<div
											className="btn btn-primary px-5 py-2"
											data-bs-toggle="modal"
											data-bs-target="#ActivationKeyCard"
										>
											Buy
										</div>
									)}
			...
			<div
				...
				id="ActivationKeyCard"
				tabindex="-1"
				aria-labelledby="ActivationKeyCardLabel"
				aria-hidden="true"
			>
						...
						<div className="modal-body">
							...
							<div className="row mt-5">
								...
								<div className="col-7 font-roboto fs-14 fw-700">
									<p>Ticket</p>
									<p>Rp. 10.000</p>
									<p>{activationKey.pcs}</p>
									<p>Rp. {activationKey.total.toLocaleString().replaceAll(",",".")}</p>
								</div>
							</div>
							<div
								className="row p-2"
