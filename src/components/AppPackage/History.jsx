...
import PaymentReportAppPackageModal from "./Invoice";

export default function AppPackageTransactionHistory() {
	...
	return (
		<>
			<div>
				...
				<table className="table mt-3 font-roboto">
					<thead>
						<tr>
					...
					<tbody className="fs-16">
						<tr>
							<td
								...
								data-bs-target="#AppackageHistoryModal-Paid"
							>
								25472548554
							</td>
							<td className="text-center py-3">07-01-2023 17:31</td>
							<td className="text-center py-3">200.000</td>
							<td className="text-center py-3">App Package</td>
						...
						<tr>
							<td
								className="text-primary py-3 pointer"
								data-bs-toggle="modal"
								data-bs-target="#AppackageHistoryModal-Pending"
							>
								25472548554
							</td>
							<td className="text-center py-3">07-01-2023 17:31</td>
			...
			<div
				...
				id="AppackageHistoryModal-Paid"
				tabindex="-1"
				aria-labelledby="AppackageHistoryModal-PaidLabel"
				aria-hidden="true"
			>
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						{/* <div class="modal-header">
							<h1 class="modal-title fs-5" id="AppackageHistoryModal-PaidLabel">
								Modal title
							</h1>
							<button
								type="button"
						...
						<div className="d-flex justify-content-between px-3 pb-3 font-inter">
							<div>
								<button
									...
									data-bs-dismiss="modal"
									data-bs-toggle="modal"
									data-bs-target="#PaymentReportAppPackageModal"
								>
									View Invoice
								</button>
							</div>
			...
			<PaymentReportAppPackageModal />

			{/* <!-- Modal Pending--> */}
			<div
				class="modal modal-lg fade"
				id="AppackageHistoryModal-Pending"
				tabindex="-1"
				aria-labelledby="AppackageHistoryModal-PendingLabel"
				aria-hidden="true"
			>
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						{/* <div class="modal-header">
							<h1 class="modal-title fs-5" id="AppackageHistoryModal-PendingLabel">
								Modal title
							</h1>
							<button
								type="button"
									...
									<div className="row px-5">
										...
										<div className="col-3">
											...
											>
												...
												>
													<p className="m-0 fs-14 font-roboto">
														Please Upload Here{" "}
														<span className="ms-2">
															<Upload />
														</span>
						...
						<div className="d-flex justify-content-between px-3 pb-3">
							<div>
								<button type="button" className="btn btn-secondary font-inter">
									View Invoice
								</button>
							</div>
