export default function PaymentReportAppPackageModal() {
	return (
		<>
			<div
				class="modal modal-lg fade"
				id="PaymentReportAppPackageModal"
				tabindex="-1"
				aria-labelledby="PaymentReportAppPackageModalLabel"
				aria-hidden="true"
			>
						...
						<div class="modal-body">
							...
							<div className="container font-roboto">
								...
								<div
									...
									style={{ fontSize: 20 }}
								>
									Tanda Terima Pembayaran App Package Anda
								</div>
								...
								<div className="row border border-2 border-dark mx-2">
									<div className="col">
										<p className="mt-3">1 x App Package</p>
