...
export default function PrimaryNumber() {
	...
	return (
		<>
			<div
				...
				id="askChangePrimaryNumber"
				tabindex="-1"
				aria-labelledby="askChangePrimaryNumberLabel"
				aria-hidden="true"
			>
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content text-inter">
						<div class="modal-header border-0 mx-3">
							<div class="modal-title" id="askChangePrimaryNumberLabel">
								<ExclamationTriangle
						...
						<div class="modal-body font-inter">
							<div className="fw-700 fs-16 mx-2">
								Apakah yakin ingin mengubah Nomor Utama?
							</div>
						...
						<div class="d-flex mx-3 mb-4 font-inter">
							...
							<button
								...
								data-bs-target="#changePrimaryNumber"
							>
								Konfirmasi
							</button>
						</div>
			...
			<div
				class="modal fade"
				id="changePrimaryNumber"
				tabindex="-1"
				aria-labelledby="changePrimaryNumberLabel"
				aria-hidden="true"
			>
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content font-inter">
						<div class="modal-header border-0 mx-4 mt-3">
							<h1 class="modal-title fs-5 fw-700" id="changePrimaryNumberLabel">
								Ganti Nomor Ponsel Utama
							</h1>
							<button
								type="button"
								class="btn-close"
