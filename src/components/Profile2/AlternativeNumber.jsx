...
export default function AlternativeNumber() {
	...
	return (
		<>
			<div
				...
				id="askChangeAlternativeNumber"
				tabindex="-1"
				aria-labelledby="askChangeAlternativeNumberLabel"
				aria-hidden="true"
			>
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content text-inter">
						<div class="modal-header border-0 mx-3">
							<div class="modal-title" id="askChangeAlternativeNumberLabel">
								<ExclamationTriangle
						...
						<div class="modal-body font-inter">
							<div className="fw-700 fs-16 mx-2">
								Apakah yakin ingin mengubah Nomor Alternatif?
							</div>
						...
						<div class="d-flex mx-3 mb-4 font-inter">
							...
							<button
								...
								data-bs-target="#changeAlternativeNumber"
							>
								Konfirmasi
							</button>
						</div>
			...
			<div
				class="modal fade"
				id="changeAlternativeNumber"
				tabindex="-1"
				aria-labelledby="changeAlternativeNumberLabel"
				aria-hidden="true"
			>
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content font-inter">
						<div class="modal-header border-0 mx-4 mt-3">
							<h1 class="modal-title fs-5 fw-700" id="changeAlternativeNumberLabel">
								Ganti Nomor Ponsel Alternatif
							</h1>
							<button
								type="button"
								class="btn-close"
