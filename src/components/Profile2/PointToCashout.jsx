...
export default function PointToCashout() {
	...
	return (
		<>
			<div
				...
				tabindex="-1"
				aria-labelledby="PointToCashoutLabel"
				aria-hidden="true"
			>
						...
						{!transaction ? (
							<>
								<div class="modal-header">
									<h1 class="modal-title fs-5" id="PointToCashoutLabel">
									...
									<>
										<div class="modal-body px-5">
											<div className="font-inter fw-400 fs-14">
												...
												<span className="fw-600" style={{ fontSize: 20 }}>
													{ kyc ? 150 : 0} <Gem className="fw-bold text-warning" />
												</span>
											</div>
											<input
												type="number"
										...
										<div class="modal-footer">
											...
											>
												...
												type="button"
												class="btn btn-secondary me-5 px-4"
											>
												Next
											</button>}
									...
									<>
										<div class="modal-body px-5">
											<div>
												...
												>
													<div className="font-inter fw-400 fs-14 py-2 px-4">
														BCA
													</div>
													<div className="font-inter fw-400 fs-14 py-2 px-4 ">
														Edit
